      ...
      <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <button 
            @click="handleSync" 
            :disabled="isSyncing"
            class=" sm:flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-4 py-2 rounded-lg transition-colors"
          >
